...
with open('d:/dishes_list.txt', encoding="utf-8") as text:
    ...
    for name in lines:
        ...
        continue
print('cook_book =',
      (json.dumps(cook_book_dict, indent=2, ensure_ascii=False)))

# Задача 2
cook_book = {
    'Омлет': [{
        'ingridient_name': 'Яйцо',
        'quantity': 2,
        'measure': 'шт'
    }, {
        'ingridient_name': 'Молоко',
        'quantity': 100,
        'measure': 'мл'
    }, {
        'ingridient_name': 'Помидор',
        'quantity': 2,
        'measure': 'шт'
    }],
    'Утка по-пекински': [{
        'ingridient_name': 'Утка',
        'quantity': 1,
        'measure': 'шт'
    }, {
        'ingridient_name': 'Вода',
        'quantity': 2,
        'measure': 'л'
    }, {
        'ingridient_name': 'Мед',
        ...
        'ingridient_name': 'Соевый соус',
        'quantity': 60,
        'measure': 'мл'
    }],
    'Запеченный картофель': [{
        'ingridient_name': 'Картофель',
        'quantity': 1,
        'measure': 'кг'
    }, {
        'ingridient_name': 'Чеснок',
        'quantity': 3,
        'measure': 'зубч'
    }, {
        'ingridient_name': 'Сыр гауда',
        'quantity': 100,
        'measure': 'г'
    }]
}
...
def create_file_list(folder):
    ...
    for file in file_list:
        with open(f"{folder}/{file}") as _temp_file:
...
def create_join_file(folder, filename):
    with open(f'{filename}.txt', 'w+') as join_file:
